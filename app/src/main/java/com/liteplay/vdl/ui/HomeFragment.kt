...
import com.liteplay.vdl.adapters.VidInfoAdapter
import com.liteplay.vdl.adapters.VidInfoListener

import org.yausername.dvd.model.VidInfoItem
import com.liteplay.vdl.vm.LoadState
import com.liteplay.vdl.vm.VidInfoViewModel
import com.liteplay.vdl.work.DownloadWorker
import com.liteplay.vdl.work.DownloadWorker.Companion.acodecKey
import com.liteplay.vdl.work.DownloadWorker.Companion.downloadDirKey
import com.liteplay.vdl.work.DownloadWorker.Companion.formatIdKey
import com.liteplay.vdl.work.DownloadWorker.Companion.nameKey
import com.liteplay.vdl.work.DownloadWorker.Companion.sizeKey
import com.liteplay.vdl.work.DownloadWorker.Companion.urlKey
import com.liteplay.vdl.work.DownloadWorker.Companion.vcodecKey
import com.liteplay.vdl.work.DownloadWorker.Companion.taskIdKey
...
class HomeFragment : Fragment(), SearchView.OnQueryTextListener,
    ...
    override fun onPrepareOptionsMenu(menu: Menu) {
        ...
        (activity as MainActivity).supportActionBar?.themedContext?.let {
            val searchView = context?.let { it1 -> SearchView(it1) }
